...
export const PIPELINE_ID = 'agentbio-ai-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Capture inputs for AgentBio AI",
  process: "Step 2/3 · Apply rules & draft with AgentBio AI",
  output: "Step 3/3 · Deliver AgentBio AI result",
}
