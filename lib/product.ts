...
export const PRODUCT = {
  name: "AgentBio AI",
  slug: "agentbio-ai",
  productId: "PROD_1jeQFj8xX1J4qfpjTI0ZNj",
  priceMonthly: 15,
  yearlyProductId: "PROD_3XIHmzROtfMbFMoRR1UeQs",
  priceYearly: 150,

  checkoutUrl: "https://pancake.waffo.ai/store/lixingliang-ai-tools-6cilbw8v/checkout/cs_f6f99515-54fa-ee51-1d9b-d1fb7c9f3efe",
  ...
  definitionLead: "AgentBio AI — An agent bio that builds trust in 60 seconds. Use it as decision-support: demo mode works without a live key; live runs require configuration. No fabricated metrics, and no claims for SSO/CSV/Slack unless that surface is actually shipped.",
  geoFaq: [
    { q: "What is AgentBio AI?", a: "An agent bio that builds trust in 60 seconds." },
    { q: "Who should use AgentBio AI?", a: "Operators and builders who need a fast first draft or checklist from AgentBio AI." },
