 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="agentbio-ai" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "agentbio-ai";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "agentbio-ai") + "_chat_session";
