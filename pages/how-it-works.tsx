    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Get a structured your agent in three steps.</p>
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            <div className="rounded-xl border border-slate-200 bg-white p-6"><h3 className="font-semibold text-slate-900">1 · Paste input</h3><p className="mt-2 text-sm text-slate-600">The prompt, config, or text AgentBio AI needs.</p></div>
            <div className="rounded-xl border border-slate-200 bg-white p-6"><h3 className="font-semibold text-slate-900">2 · Run AgentBio AI</h3><p className="mt-2 text-sm text-slate-600">The engine produces a structured your agent.</p></div>
